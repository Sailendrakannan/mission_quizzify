    ...
    def ingest_documents(self):
        ...
        if uploaded_files is not None:
            for uploaded_file in uploaded_files:
                ...
                #pages = pdf_loader.extract_pages()
                loader = PyPDFLoader(temp_file_path)
                loaded_pages = loader.load_and_split()

                self.pages.extend(loaded_pages)
      
            #####################################
            # Now you have all the extracted pages stored in the 'pages' list
            # You can further process or analyze these pages as needed
