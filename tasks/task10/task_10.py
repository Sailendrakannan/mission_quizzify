    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                topic_input = st.text_input("Enter the topic:",placeholder = "Enter the topic of document:")
                questions = st.number_input("Enter the number of questions:", min_value=1, max_value=10, value =1)
                ##### YOUR CODE HERE #####
