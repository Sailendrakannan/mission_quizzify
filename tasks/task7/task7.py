...
class QuizGenerator:
    ...
    def init_llm(self):
        ...
        self.llm = VertexAI(model_name=self.model_name, temperature = self.temperature, max_output_tokens = self.max_output_tokens
            ############# YOUR CODE HERE ############
        )
    ...
    def generate_question_with_vectorstore(self):
        ...
        if self.vectorstore is None:
            ...
            #raise ValueError("LLM is not initialized. Please initialize the LLM using the 'init_llm' method.")
