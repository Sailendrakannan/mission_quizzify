...
sys.path.append(os.path.abspath(r'C:\Users\saile\mission-quizify'))
...
if __name__ == "__main__":
    ...
    embed_config = {
        ...
        "project": "academic-osprey-419918",
    ...
    with screen.container():
        ...
        doc_proc.ingest_documents()

        embedding = EmbeddingClient(model_name= "textembedding-gecko@003", project= "academic-osprey-419918", location= "us-central1")

        chroma_collection = ChromaCollectionCreator(doc_proc, embedding)
        ####### YOUR CODE HERE #######
        ...
        with st.form("Load Data to Chroma"):
            ...
            topic_for_quiz = st.text_input("Enter the topic of the document")
            num_of_questions = st.slider("Select the number of questions", min_value = 1, max_value = 10, value = 5)
            ...
            if submitted:
                ...
                chroma_creator = chroma_collection.create_chroma_collection()
                ####### YOUR CODE HERE #######
                ...
                document = chroma_collection.query_chroma_collection(topic_input) 
