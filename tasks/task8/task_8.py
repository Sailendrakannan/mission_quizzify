...
class QuizGenerator:
    ...
    def generate_quiz(self) -> list:
        ...
        for _ in range(self.num_questions):
            ...
            if self.validate_question(question):
                ...
                self.quiz.append(question["question"])
            else:
            ...
            while retries < retry_limit:
                ...
                if self.validate_question(question):
                    ...
                    print("Invalid question detected and try for another question")

                    retries = retries + 1
                    if retries == retry_limit:
                        print("Reached max retry limit and so the questions will not be seen in the quiz")
    ...
    def validate_question(self, question: dict) -> bool:
        ...
        if question["question"] == '':
            print("The question is invalid")
        else:
            if question["question"] in self.quiz:
                is_unique = False
            else:
                is_unique = True
            return is_unique
